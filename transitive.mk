...
iftrue ${TRANSITIVE_DEPENDENCIES}
	...
	DEPENDENCY_LIBRARY_FILES_STATIC_NODEBUG:=$(shell ./scripts/expandLibraries.sh static-nodebug ${TRANSITIVE_DEPENDENCIES})
	DEPENDENCY_LIBRARY_FILES_STATIC_DEBUG:=$(shell ./scripts/expandLibraries.sh static-debug ${TRANSITIVE_DEPENDENCIES})
	DEPENDENCY_LIBRARY_FILES_DYNAMIC_NODEBUG:=$(shell ./scripts/expandLibraries.sh dynamic-nodebug ${TRANSITIVE_DEPENDENCIES})
	DEPENDENCY_LIBRARY_FILES_DYNAMIC_DEBUG:=$(shell ./scripts/expandLibraries.sh dynamic-debug ${TRANSITIVE_DEPENDENCIES})
	DEPENDENCY_MEGA_OBJECTS_NODEBUG:=${DEP_MEGA_NODEBUG}
	DEPENDENCY_MEGA_OBJECTS_DEBUG:=${DEP_MEGA_DEBUG}
else
	MODULE_LIBRARY_PATH:=
	MODULE_LIB_PATH:=
	DEP_MEGA_DEBUG:=
	DEP_MEGA_NODEBUG:=
	DEPENDENCY_LIBRARY_FILES_STATIC_NODEBUG:=
	DEPENDENCY_LIBRARY_FILES_STATIC_DEBUG:=
	DEPENDENCY_LIBRARY_FILES_DYNAMIC_NODEBUG:=
	DEPENDENCY_LIBRARY_FILES_DYNAMIC_DEBUG:=
	DEPENDENCY_MEGA_OBJECTS_NODEBUG:=
	DEPENDENCY_MEGA_OBJECTS_DEBUG:=
endif
